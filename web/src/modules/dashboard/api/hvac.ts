...
export async function listAccessibleBuildings(): Promise<Building[]> {
  const response = await requestApi<PageResult<Building>>({
...
export async function getHvacSnapshot(
  ...
  return requestApi<HvacSnapshotResponse>({
    method: 'GET', url: `/hvac/buildings/${encodeURIComponent(buildingId)}/snapshot`,
  })
}
...
export async function getLatestHvacIndicators(
  ...
  return requestApi<HvacLatestResponse>({
    method: 'GET', url: `/hvac/buildings/${encodeURIComponent(buildingId)}/indicators/latest`,
  })
}
...
export async function getHvacIndicatorTrends(
  ...
  return requestApi<HvacIndicatorTrendResponse>({
    method: 'GET',
    url: `/hvac/buildings/${encodeURIComponent(buildingId)}/indicators/trends`,
...
export async function getHvacPointHistory(
  ...
  return requestApi<HvacPointHistoryResponse>({
    method: 'GET',
    url: `/hvac/buildings/${encodeURIComponent(buildingId)}/history`,
...
export async function getIndicatorCalculationDetail(
  ...
  return requestApi<HvacCalculationDetail>({
    method: 'GET',
    url: `/hvac/indicators/${encodeURIComponent(indicatorId)}/calculations/${minuteStart}`,
  })
}
