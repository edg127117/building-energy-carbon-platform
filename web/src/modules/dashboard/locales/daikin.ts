export default {
  ...
  statusNames: { VENDOR_COMMUNICATION: '设备通信故障', VENDOR_EQUIPMENT: '设备故障', VENDOR_MAINTENANCE: '设备维护', FILTER_MAINTENANCE: '滤网维护', CONTROLLER_COMMUNICATION: '控制器通信故障', SOURCE_FETCH: '来源取数异常', RUNTIME_FETCH: '运行统计取数异常', DEVICE_STALE: '设备数据过期', totalRuntime: '累计运行时长', PRESENT: '有结果', MISSING: '缺失', INVALID: '无效', UNKNOWN: '未知', QUEUED: '待执行', RUNNING: '执行中', RETRY_WAIT: '等待重试', SUCCEEDED: '已完成', UNSUPPORTED: '不支持', FAILED: '失败', EXPIRED: '已过期', on: '开', off: '关', cooling: '制冷', heating: '制热', fan: '送风', dry: '除湿', low: '低档', middle: '中档', high: '高档', automatic: '自动', operating: '运行', stopped: '停止' },
} as const
