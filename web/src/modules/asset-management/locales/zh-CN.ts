export default {
  ...
  meter: {
    ...
    liveStatus: '实时监测中 (10秒静默刷新)',
    offlineStatus: '离线 (未接收最新上报)',
    lastUpdate: '更新于 {time}',
    realtimePower: '实时总有功功率',
    positiveEnergy: '正向累计用电量',
    powerFactor: '综合功率因数',
    ...
    pfLow: '偏低',
    trendTitle: '实时负荷走势',
    pointsListTitle: '实时测点读数清单 (TDengine 实测入库)',
    q0Legend: 'Q0 现场实测',
    q1Legend: 'Q1 校验插值',
    q2Legend: 'Q2 典型参考',
    q0Label: '实测 (Q0)',
    ...
    pointCodeHeader: '测点代码',
    pointNameHeader: '测点名称 (业务中文)',
    realtimeValueHeader: '实时实测值',
    unitHeader: '单位',
    qualityHeader: '数据质量',
    ...
    unitA: '电流 (A)',
    unitV: '电压 (V)',
    threePhaseTrendTitle: '实时总功率与三相电流走势 (最近30分钟)',
    singlePhaseTrendTitle: '实时用电功率与电压走势 (最近30分钟)',
    realtimePulse: '数据正实时推移',
    trendSubtitle: '双轴动态波形 · 轮询静默自适应',
    phaseACurrent: 'A相电流 (A)',
    phaseBCurrent: 'B相电流 (A)',
    phaseCCurrent: 'C相电流 (A)',
