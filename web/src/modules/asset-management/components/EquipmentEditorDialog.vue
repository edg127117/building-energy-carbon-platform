...
function submit() {
  ...
  emit('save', {
    ...
    ratedCapacity: form.ratedCapacity ?? null,
    ratedPower: form.ratedPower ?? null,
    designCop: form.designCop ?? null,
    status: 'ACTIVE',
  })
}
  ...
  <ElDialog :model-value="open" :title="title" @update:model-value="emit('close')">
    <ElForm label-position="top" @submit.prevent="submit">
      ...
      <div class="two-columns">
        ...
        <ElFormItem :label="t('assetManagement.labels.ratedCapacity')"><ElInputNumber v-model="form.ratedCapacity" :min="0" class="wide-control" /></ElFormItem>
        <ElFormItem :label="t('assetManagement.labels.ratedPower')"><ElInputNumber v-model="form.ratedPower" :min="0" class="wide-control" /></ElFormItem>
        <ElFormItem :label="t('assetManagement.labels.designCop')"><ElInputNumber v-model="form.designCop" :min="0" class="wide-control" /></ElFormItem>
      </div>
