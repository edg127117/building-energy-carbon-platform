...
CREATE TABLE IF NOT EXISTS `iot_protocol_profile` (
    ...
    `message_id_path` VARCHAR(200) DEFAULT NULL,
    `boot_id_path` VARCHAR(200) DEFAULT NULL,
    `batch_id_path` VARCHAR(200) DEFAULT NULL,
    `retransmitted_at_path` VARCHAR(200) DEFAULT NULL,
