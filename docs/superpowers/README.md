...
| 前端 ESLint 基线与 CI 门禁 | [设计](specs/2026-08-04-frontend-eslint-baseline-design.md) | [计划](plans/2026-08-04-frontend-eslint-baseline.md) | 成对历史记录 | 当前仍处于设计与计划阶段；实施完成状态须核对代码、CI 和项目状态。 |
