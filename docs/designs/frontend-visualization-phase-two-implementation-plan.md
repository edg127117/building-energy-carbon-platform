...
- 数字字体：DINPro；
- 默认行高：字号的 1.5 倍；
- 字号尺度：12、14、16、18、20、24、28、40、44px；其中 18px 用于已确认的大屏适配；
...
本章是据此整理的设计方案，具体实施规则待确认；尚未进行本轮视觉编码或浏览器验收。
...
| 浅色、字体、组件库与设计变量 | 保留并细化 | 统一浅蓝灰背景、白色表面和蓝色选中态；不新增主题系统 |
...
保留第 8 章原始字号、间距和圆角尺度。以下为建议实施起点，需在编码前确认方案、编码后用真实浏览器复核：
...
| 字体 | 系统名称 24px、一级导航及系统卡片名称 20px、页面标题 16px、正文和辅助文字 14px |
...
正式 Logo 素材仍待提供；本章尺寸和细节属于待确认实施方案。业务页面内容、搜索与消息业务、
