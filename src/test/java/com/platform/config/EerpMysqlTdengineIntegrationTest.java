...
class EerpMysqlTdengineIntegrationTest {
    @Test void migratesIsolatedMysqlAndPublishesNativeValuesOnlyAfterTdengineSuccess() {
        ...
        assertThat(index.queryForObject("SELECT version FROM flyway_schema_history WHERE success=1 ORDER BY installed_rank DESC LIMIT 1",String.class)).isEqualTo("49");
