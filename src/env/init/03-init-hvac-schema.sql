...
-- 冻结书 7.1：5 级菜单树（本期启用的部分）
-- 一级：常规调适
INSERT INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `menu_type`, `path`, `component`, `icon`, `sort_order`) VALUES
                                                                                                                    (100, 0,    '常规调适',    'M', '/commissioning', NULL,       'dashboard', 1),
                                                                                                                    (110, 100,  '单机调适',    'M', '/single',        NULL,       'control',   1),
                                                                                                                    (120, 110,  '变风量空调系统','M','/single/vav',    NULL,       'apartment', 1),
-- 冷水机组
                                                                                                                    (130, 120,  '冷水机组',    'M', '/single/vav/chiller', NULL,  'cpu',       1),
                                                                                                                    (131, 130,  '制冷量计算',  'C', '/single/vav/chiller/cooling-capacity', 'commissioning/ChillerCooling', 'function', 1),
                                                                                                                    (132, 130,  'COP 计算',    'C', '/single/vav/chiller/cop',              'commissioning/ChillerCop',     'function', 2),
                                                                                                                    (133, 130,  '吸收式 COP',  'C', '/single/vav/chiller/absorption-cop',   'commissioning/AbsorptionCop',   'lock',     3),
-- 冷却塔
                                                                                                                    (140, 120,  '冷却塔',      'M', '/single/vav/tower',    NULL,  'radar',     2),
                                                                                                                    (141, 140,  '冷却塔效率',  'C', '/single/vav/tower/efficiency', 'commissioning/TowerEfficiency', 'function', 1),
-- 水泵
                                                                                                                    (150, 120,  '水泵',        'M', '/single/vav/pump',     NULL,  'sliders',   3),
                                                                                                                    (151, 150,  '水泵效率',    'C', '/single/vav/pump/efficiency',  'commissioning/PumpEfficiency',   'function', 1),
-- 风系统
                                                                                                                    (160, 120,  '风系统',      'M', '/single/vav/ahu',      NULL,  'wind',      4),
                                                                                                                    (161, 160,  '单位风量耗功值','C','/single/vav/ahu/power-efficiency', 'commissioning/AhuEfficiency', 'function', 1);

-- 一级：系统管理
INSERT INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `menu_type`, `path`, `component`, `icon`, `sort_order`) VALUES
                                                                                                                    (200, 0,    '系统管理',    'M', '/system',       NULL,        'setting',  2),
                                                                                                                    (210, 200,  '人员管理',    'M', '/system/user',  NULL,        'usergroup',1),
                                                                                                                    (211, 210,  '用户管理',    'C', '/system/user/list',        'system/UserList',   'user',     1),
                                                                                                                    (212, 210,  '角色管理',    'C', '/system/role/list',        'system/RoleList',   'team',     2),
