...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='大金运行统计日计划检查点';
CREATE TABLE IF NOT EXISTS biz_daikin_runtime_job (
  job_id CHAR(64) COLLATE utf8mb4_bin NOT NULL PRIMARY KEY,
  ...
  KEY idx_daikin_runtime_due(source_id,status,next_attempt_at_ms),
  KEY idx_daikin_runtime_job_retention(period_end_ms)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='大金运行统计有界补取任务';
CREATE TABLE IF NOT EXISTS biz_daikin_runtime_value (
  value_id CHAR(64) COLLATE utf8mb4_bin NOT NULL PRIMARY KEY,
  ...
  KEY idx_daikin_runtime_device(equipment_id,building_id,granularity,period_end_ms),
  KEY idx_daikin_runtime_value_retention(period_end_ms)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='大金厂家日月年独立统计当前版本';
CREATE TABLE IF NOT EXISTS biz_daikin_runtime_revision (
  revision_id CHAR(64) COLLATE utf8mb4_bin NOT NULL PRIMARY KEY,
  value_id CHAR(64) COLLATE utf8mb4_bin NOT NULL,
  ...
  UNIQUE KEY uk_daikin_runtime_revision(value_id,revision_no),
  KEY idx_daikin_runtime_revision_retention(period_end_ms)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='大金厂家统计修订记录不叠加';
